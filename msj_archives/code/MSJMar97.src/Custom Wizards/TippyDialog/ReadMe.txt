========================================================================
                    CUSTOM APPWIZARD: TippyDialog
========================================================================


AppWizard has created a TippyDialog DLL for you.  This DLL is the starting point
...
you build TippyDialog.awx, it will automatically be copied to your Template
...
TippyDialog.mak
    ...
    nmake /f TippyDialog.mak CFG="Win32 Debug".

    To build a release version of the program, type
    nmake /f TippyDialog.mak CFG="Win32 Release".
...
TippyDialogAw.h, TippyDialogAw.cpp - the CCustomAppWiz class
    These files contain your CCustomAppWiz-derived class,
    CTippyDialogAppWiz.  This class contains virtual member functions which
...
Template\
    ...
    import that file as a "TEMPLATE" custom resource into TippyDialog.rc.  Be
...
Template\NewProj.inf
    ...
    generated from the project "D:\CustomWizards\TippyDlgMaster\TippyDlgMaster.mak".  You will not need to edit
...
off of the project "D:\CustomWizards\TippyDlgMaster\TippyDlgMaster.mak".
...
StdAfx.h, StdAfx.cpp
    ...
    named TippyDialog.pch and a precompiled types file named StdAfx.obj.
