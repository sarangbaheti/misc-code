========================================================================
                    CUSTOM APPWIZARD: undoc
========================================================================


AppWizard has created a undoc DLL for you.  This DLL is the starting point
...
you build undoc.awx, it will automatically be copied to your Template
...
undoc.mak
    ...
    nmake /f undoc.mak CFG="Win32 Debug".

    To build a release version of the program, type
    nmake /f undoc.mak CFG="Win32 Release".
...
undocAw.h, undocAw.cpp - the CCustomAppWiz class
    These files contain your CCustomAppWiz-derived class,
    CUndocAppWiz.  This class contains virtual member functions which
...
Template\
    ...
    import that file as a "TEMPLATE" custom resource into undoc.rc.  Be
...
StdAfx.h, StdAfx.cpp
    ...
    named undoc.pch and a precompiled types file named StdAfx.obj.
